...
<view>
  ...
  <view class="address-form">
    <view class="form-item">
      ...
      <view class="item-input">
        <input type="text" maxlength="12" placeholder="名字" ng-model="name"></input>
      </view>
    ...
    <view class="form-item">
      ...
      <view class="item-input">
        <input type="tel" ng-change="validtel()" placeholder="手机或固定电话" ng-model="mobile"></input>
      </view>
    ...
    <view class="form-item no-border">
      ...
      <view class="item-input">
        <input type="tel" ng-change="validtel()" placeholder="邮政编码" ng-model="mobile"></input>
      </view>
      <view class="item-addrepeat" ng-show="mobile.length > 0" ng-click="mobile=''">
        <image :ng-src="iconURL + '/icon-addrepeat.png'"></image>
      </view>
  ...
  <view class="toggle-item row row-center">
    ...
    <view class="item-toggle col">
      <switch v-if="!canchangeDefault" @change="switchChange"></switch>
      <switch v-if="canchangeDefault" @change="switchChange"></switch>
    </view>
  </view>

  <!-- Picker -->
  <view class="drawer_screen" v-if="false" @tap="touchPickerCancel()"></view>
  <view class="address-picker" v-if="false" ng-show="showPicker">
  ...
  <!-- Dialog -->
  <view id="dialog" v-if="false" ng-show="showDelAddressDialog">
