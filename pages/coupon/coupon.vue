  ...
  <view class="coupon-content">
    ...
    <view class="list" v-if="vou && vou.length > 0">
      ...
      <view v-for="(bonus, index) in vou" :key="index">
        <!-- 未使用列表 -->
        <view class="box_list row" :style="'background-image:url(' + iconURL + '/coupon_orange01.png)'" v-if="currentTab == 0 && bonus.status == 0">
          <!-- 左侧面额 -->
          ...
          <!-- 右侧领取部位 -->
          <form class="get_coupon_btn col-30" @submit="like" :data-id="bonus.id" v-if="!bonus.is_used">
