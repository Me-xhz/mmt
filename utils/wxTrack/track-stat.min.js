...
if (y.info = function() {
		...
		var e = c.forEach,
			...
			i = o.each = function(t, o, n) {
				if (null == t) return !1;
				if (e && t.forEach === e) t.forEach(o, n);
		...
		if (o.isObject(e) && !o.isEmptyObject(e)) {
			...
			o.each(e, function(e, o) {
				if (i.test(o)) r = "_" + o.replace(i, ""), console.warn("将event_name:" + o + "转换为" + r), n[r] = e;
				else if (t.test(o)) {
					var r = o.replace(t, "_");
					console.warn("将event_name:" + o + "转换为" + r), n[r] = e;
				} else n["_" + o] = e;
			...
			wx.login({
				success: function(t) {
					t.code && a.para.appid && a.para.openid_url ? wx.request({
						...
						method: "GET",
						complete: function(t) {
							o.isObject(t) && o.isObject(t.data) && t.data.openid ? e(t.data.openid) : e();
						}
					}) : e();
				}
			});
		...
		if (g.indexOf(e) >= 0) t.$isDefaultTrack = !0;
		else {
			if (i.test(e)) {
				var r = e.replace(i, "");
				console.warn("将event_name: " + e + " 转换为 " + r), e = r;
			}
			...
			if (o.isObject(t)) {
				...
				o.each(t, function(e, t) {
					var o = t.replace(i, "");
					a[o] = e, console.warn("将key: " + t + " 转换为 " + o);
				}), t = a;
			}
		}
		this.prepareData({
