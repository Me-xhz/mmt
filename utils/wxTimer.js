...
wxTimer.prototype = {
  ...
  start: function (self) {
    ...
    function begin() {
      var tmpTime = new Date(that.endTime - 1000 * count++); //把2011年1月1日日 00：00：00换成数字型，这样就可以直接1s，1s的减，就变成了倒计时，为了看的更明确，又用new date把字符串换回来了
      ...
      var wxTimerList = self.wxTimerList; //更新计时器数组
